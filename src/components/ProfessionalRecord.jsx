    ...
    <div className="bg-background text-on-background fixed inset-0 h-[100dvh] w-screen overflow-hidden overscroll-none flex flex-col font-body-md dark">
      ...
      <div className={`flex-1 w-full relative flex flex-col group ${layoutMode} mb-[72px] landscape:mb-0 landscape:mr-[72px]`} id="layout-container">
        ...
        >
          ...
          <div className="fixed bottom-[100px] right-4 landscape:right-[100px] landscape:bottom-8 w-auto z-40">
            <div className="bg-[#1a1a24]/90 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl py-3 px-2 flex flex-col items-center gap-2">
              ...
              <div className="flex flex-col items-center justify-center py-1">
                <span className="font-black text-primary text-[16px] leading-none">{speed / 5}x</span>
              </div>
              <button onClick={() => adjustSpeed(-1)} className="w-10 h-10 flex items-center justify-center text-white/50 hover:text-white bg-white/5 hover:bg-white/10 rounded-full transition-colors active:scale-95">
                <span className="material-symbols-outlined text-[22px] font-bold">remove</span>
              </button>
              <div className="flex items-center justify-center w-full mt-1 border-t border-white/10 pt-2">
